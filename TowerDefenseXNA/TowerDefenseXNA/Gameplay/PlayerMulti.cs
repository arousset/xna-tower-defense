...
namespace TowerDefenseXNA
{
    public class PlayerMulti
    {
        ...
        // Constructor 
        public PlayerMulti(Level level, Texture2D[] towerTextures, Texture2D bulletTexture, Texture2D rangeTexture, int life, int money, SoundEffect[] bulletsAudio, Texture2D btsell, Texture2D btreplace, Texture2D btupgrade, SpriteFont font, Texture2D ranksilver, Texture2D rankgold)
        {
